...
int main(){
   ...
   while(1){
        ...
        if(op<3){
           if(op!=2){
              ...
              for(int i=1;i<players+1;i++){
                 ...
                 if(guess==num){
                    ...
                    if(p[i].get_instinct()) { tell(1,guess,num,p[i].get_hints(),p[i].get_temp()); p[i].set_instinct(rand()%2);}
                    else {tell(0,guess,num,p[i].get_hints(),p[i].get_temp()); p[i].set_instinct(rand()%2);}
           ...
           cout<<"INTERACTION\n\n";
           ifstream infile;
           infile.open("how to play the game.txt");
           string data;
           if (infile.is_open())
           {
